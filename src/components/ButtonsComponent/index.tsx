...
const ButtonsComponent: Component<ButtonsProps> = (props: ButtonsProps) => {
    ...
    function handleChangeNodeType(event: any) {
        setNodeType(event.target.value);
    }
    function handleChangeLabel(event: any) {
    ...
    return (
        <div class={styles.wrapper}>
            ...
            >
                ...
                <select class={styles.input} onchange={handleChangeNodeType} value={nodeType()}>
                    <option value="1">Type1</option>
                    <option value="2">Type2</option>
                </select>
                <label class={styles.label}>Title Label</label>
                <input class={styles.input} type="string" value={label()} onInput={handleChangeLabel}></input>
